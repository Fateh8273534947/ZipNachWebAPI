...
namespace ZipNachWebAPI.Controllers
{
    ...
    public class UploadMandateOrgController : ApiController
    {
        ...
        [Route("api/UploadMandateOrg/uploadA4scan")]
        [HttpPost]
        ...
        [Route("api/UploadMandate/CheckEsign")]
        [HttpPost]
        ...
        public class ResponseDataorg
        {
          ...
          //  private string retList { get; set; }


        }
        public class ResChkESignData
        {
            public string Message { get; set; }
            public string Status { get; set; }
