...
{
    public class ActivityDeleteController : ApiController
    {

        [Route("api/ActivityDelete/UMRNHold")]
        [HttpPost]
        public loginResponse UMRNHold(SavePresentmentDetails ul)
        {
            ...
            else
            {
                ...
                if (Flag)
                {
                    ...
                    string createsinglexml = ValidatePresement.CreateUMRNXML(xml);
                    ...
                    try
                    {
                        ...
                        dbcommand = new SqlCommand(query, conn);
                        dbcommand.CommandType = CommandType.StoredProcedure;
                        dbcommand.Parameters.AddWithValue("@QueryType", "EXISTINGACTIVITYDELETE");
                        ...
                        else
                        {
                            if (ds.Tables[1].Rows.Count > 0 && ds.Tables[2].Rows.Count > 0)
                            {
                                ...
                                res.ResCode = "ykR30004";
                                res.ResDescription = "Records Hold Successfully";
